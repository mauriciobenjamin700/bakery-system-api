...
class IngredientService:
    ...
    def add(self, ingredient_request: IngredientRequest) -> dict:
        ...
        try:
            ...
            ingredient_on_db = (
                self.db_session.query(IngredientModel)
                .filter_by(
            ...
            if ingredient_on_db:
                ...
                self.db_session.add(
                    LoteIngredientModel(
                        **data_insert_lote,
                        ingredient_id=ingredient_on_db.id,
                ...
                return {
                    "msg": "Ingrediente já existe, então o ingrediente foi salvo como lote"
                }
    ...
    def update(self, update: IngredientRequest) -> dict:
        ...
        try:
            ...
            self.db_session.refresh(
                ingredient
            )  # Atualiza o objeto com os dados salvos no banco de dados.
    ...
    def add_lote(self, lote_ingredient_request: LoteIngredientRequest) -> dict:
        ...
        try:
            ...
            ingredient_on_db = (
                self.db_session.query(IngredientModel)
                .filter_by(id=lote_ingredient_request.ingredient_id)
                .first()
            )
    ...
    def delete_lote(self, lote_id: int) -> dict:
        ...
        try:
            ...
            lote = (
                self.db_session.query(LoteIngredientModel)
                .filter_by(id=lote_id)
                .first()
            )
    ...
    def get_by_id(self, ingredient_id) -> IngredientResponse:
        ...
        try:
            ...
            return IngredientResponse(**ingredient.dict(), quantity=quantity)

        except Exception as e:
            # Levanta a exceção em caso de erro.
            raise e

    def _get_lote_ingredient(
        self, ingredient_id: int
    ) -> list[LoteIngredientResponse]:
        """
    ...
    def get_ingredient_and_lots(self, ingredient_id: int) -> dict:
        ...
        try:
            ...
            ingredient_response = IngredientResponse(
                **ingredient.dict(), quantity=total_quantity
            )
    ...
    def get_all(self) -> list[dict]:
        ...
        try:
            ...
            for ingrendient in ingredients:
                response.append(self.get_ingredient_and_lots(ingrendient.id))
